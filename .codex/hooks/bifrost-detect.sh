...
{
  write_env "BIFROST_HAS_SOURCE" "$BIFROST_HAS_SOURCE"
  write_env "BIFROST_SDK_INSTALLED" "$BIFROST_SDK_INSTALLED"
  write_env "BIFROST_LOGGED_IN" "$BIFROST_LOGGED_IN"
  write_env "BIFROST_MCP_CONFIGURED" "$BIFROST_MCP_CONFIGURED"
  [ -n "$BIFROST_DEV_URL" ] && write_env "BIFROST_DEV_URL" "$BIFROST_DEV_URL"
  [ -n "$BIFROST_SOURCE_PATH" ] && write_env "BIFROST_SOURCE_PATH" "$BIFROST_SOURCE_PATH"
  [ -n "$BIFROST_PYTHON_CMD" ] && write_env "BIFROST_PYTHON_CMD" "$BIFROST_PYTHON_CMD"
  [ -n "$BIFROST_PYTHON_VERSION" ] && write_env "BIFROST_PYTHON_VERSION" "$BIFROST_PYTHON_VERSION"
  [ -n "$BIFROST_PIP_CMD" ] && write_env "BIFROST_PIP_CMD" "$BIFROST_PIP_CMD"
  [ -n "$BIFROST_OS" ] && write_env "BIFROST_OS" "$BIFROST_OS"
} >> "$CLAUDE_ENV_FILE"
