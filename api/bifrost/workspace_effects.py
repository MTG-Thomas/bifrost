...
This standalone copy is shipped with the downloadable SDK.  Keep its public
contract aligned with ``shared.workspace_effects`` in the platform runtime.
The declarations are metadata only and do not enforce limits by themselves.
"""
