...
_DEFINITIONS = {
    ...
    WORKSPACE_REPO_CLOSURE_DEFINITION.job_type: WORKSPACE_REPO_CLOSURE_DEFINITION,
    WORKSPACE_PATH_DELETION_DEFINITION.job_type: WORKSPACE_PATH_DELETION_DEFINITION,
}
