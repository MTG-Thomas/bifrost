...
from src.core.module_cache_sync import resolve_module_sync, workspace_generation_for_import
...
class VirtualModuleLoader(Loader):
    ...
    def __init__(
        ...
        Args:
            ...
            workspace_generation: Workspace source generation pinned by the execution
        """
        self.path = path
    ...
    def _find_spec_impl(self, fullname: str, path: Any | None = None) -> ModuleSpec | None:
        ...
        if resolution.kind in {"module", "package"} and resolution.content is not None:
            ...
            loader = VirtualModuleLoader(
                ...
                workspace_generation=workspace_generation_for_import(),
            )
            spec = ModuleSpec(
                fullname,
                loader,
