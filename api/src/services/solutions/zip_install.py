...
A "zip" is a compressed Solution *workspace* — the same shape the retired
portable export flow produced: a ``bifrost.solution.yaml`` descriptor + ``.bifrost/*.yaml`` manifests
